...
urlpatterns = [
    ...
    path('assignhod/',views.assignhod,name='assignhod'),
    path('gethod/',views.gethod,name='gethod'),
    path('deletehod/',views.deletehod,name='deletehod'),
    path('hodpage/',views.hodpage,name='hodpage'),
    path('hodbranches/',views.hodbranches,name='hodbranches'),
    path('hodgetbranches/',views.hodgetbranches,name='hodgetbranches'),
    path('hodsections/', views.hodsections, name='hodsections'),
    path('hodgetyears/',views.hodgetyears,name='hodgetyears'),
    path('hodgetsubject/',views.hodgetsubject,name='hodgetsubject'),
    path('hodsections.html', TemplateView.as_view(template_name='hodsections.html'), name='hodsections'),
    path('hodfeedback/',views.hodfeedback,name='hodfeedback'),
    path('hodfeedback.html', TemplateView.as_view(template_name='hodfeedback.html'), name='hodfeedback'),
    path('hodfeedbackofsubject/',views.hodfeedbackofsubject,name='hodfeedbackofsubject'),
    path('hodfeedbackofsubject.html', TemplateView.as_view(template_name='hodfeedbackofsubject.html'), name='hodfeedbackofsubject'),
    path('hod_get_question_wise_analysis/',views.hod_get_question_wise_analysis,name='hod_get_question_wise_analysis'),
    path('hod_get_student_comments/',views.hod_get_student_comments,name='hod_get_student_comments'),
    path('hod_downloadoverallreport',views.hod_downloadoverallreport,name='hod_downloadoverallreport'),
    path('hod_downloadoverallreporthtml/',views.hod_downloadoverallreporthtml,name='hod_downloadoverallreporthtml'),
